...
public class EnemyuponDeath : MonoBehaviour
{
    ...
    {
        maxSavedTimes = Mathf.Clamp((int)(lifenum * coSaveTimes), minSaveTimes, maxSaveTimes);

        turnSpeed = Mathf.Clamp(lifenum * coTurnSpeed, minTurnSpeed, maxTurnSpeed);

        chargespeed = Mathf.Clamp((lifenum * coChargeSpeed), minChargeSpeed, maxChargeSpeed);
        ...
        pointedToleranceSave = Mathf.Clamp((int)(lifenum * cosavetol), minsavetol, maxsavetol);
        ...
        chargemax = Mathf.Clamp((lifenum * coChargeMax), minChargeMax, maxChargeMax);
